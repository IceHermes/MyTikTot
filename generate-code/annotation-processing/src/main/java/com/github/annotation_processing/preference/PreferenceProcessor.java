package com.github.annotation_processing.preference;

import com.google.auto.service.AutoService;
import com.squareup.javapoet.TypeName;
import com.sun.source.util.Trees;
import com.github.annotation.preference.BuiltInObjectPreference;
import com.github.annotation.preference.OtherObjectPreference;
import com.github.annotation.preference.PreferenceAnnotation;
import com.github.annotation_processing.preference.model.PreferenceHelperBuilder;
import com.github.annotation_processing.preference.proxy.AnnotationProxy;
import com.github.annotation_processing.preference.proxy.BuiltInObjectProxy;
import com.github.annotation_processing.preference.proxy.OtherObjectProxy;
...
import static com.github.annotation_processing.util.SortedElement.COMPARATOR;

/**
 * Created by whensunset on 2018/10/5.
 */
@AutoService(Processor.class)
@SupportedAnnotationTypes({"com.github.annotation.preference.PreferenceAnnotation",
    "com.github.annotation.preference.PrimitivePreference",
    "com.github.annotation.preference.ObjectPreference",
    "com.github.annotation.preference.AsBoolean"})
...
public class PreferenceProcessor extends BaseProcessor {
  ...
  public final static String DEFAULT_PACKAGE = "com.github";
